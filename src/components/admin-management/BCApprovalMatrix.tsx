              ...
              <table className="min-w-full table-auto">
                <thead className="bg-slate-100 dark:bg-gray-900 sticky top-0 z-10">
                  <tr>
                    ...
                    <th className="text-left px-6 py-4 text-sm font-semibold text-slate-800 dark:text-gray-200 whitespace-nowrap">EXCEPTION</th>
                    <th className="text-left px-6 py-4 text-sm font-semibold text-slate-800 dark:text-gray-200 whitespace-nowrap">EXCEPTION APPROVER</th>
                  ...
                  {filteredSchemas.length === 0 ? (
                    ...
                    filteredSchemas.map((schema) => (
                      <tr key={schema.id} className="hover:bg-slate-100/80 dark:hover:bg-gray-700/50 transition-colors cursor-pointer" onDoubleClick={() => handleEdit(schema)}>
                        ...
                        <td className="px-6 py-4 text-slate-800 dark:text-gray-200 whitespace-nowrap">{schema.exception || '-'}</td>
                        <td className="px-6 py-4 text-slate-800 dark:text-gray-200 whitespace-nowrap">{schema.exceptionapprover || '-'}</td>
            ...
            <div className="px-6 py-5 space-y-5 overflow-y-auto flex-1 custom-scrollbar">
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex flex-col gap-1">
                    <label className="text-xs font-medium text-slate-500 dark:text-gray-400 uppercase tracking-wide">Exception</label>
                    <input
                      type="text"
                      className="px-3 py-2.5 rounded-lg bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 text-slate-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
