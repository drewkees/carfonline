    ...
    <div className="h-full bg-background flex flex-col">
            ...
            <div className="flex-1 overflow-auto bg-white dark:bg-gray-800 rounded-lg shadow custom-scrollbar">
              <table className="min-w-full table-auto">
                <thead className="bg-slate-100 dark:bg-gray-900 sticky top-0 z-10">
                  <tr>
                    <th className="text-left px-6 py-4 text-sm font-semibold text-slate-700 dark:text-gray-200 whitespace-nowrap">PAYMENT LIMIT</th>
                    <th className="text-left px-6 py-4 text-sm font-semibold text-slate-700 dark:text-gray-200 whitespace-nowrap">LIMIT TYPE</th>
                    <th className="text-left px-6 py-4 text-sm font-semibold text-slate-700 dark:text-gray-200 whitespace-nowrap">LIMIT GROUP</th>
                ...
                <tbody className="divide-y divide-slate-200 dark:divide-gray-700">
                  {filteredSchemas.map((schema) => (
                    <tr key={schema.id} className="hover:bg-slate-100/80 dark:hover:bg-gray-700/50 transition-colors">
                      <td className="px-6 py-4 text-slate-800 dark:text-gray-200 whitespace-nowrap">{schema.paymentlimit}</td>
      ...
      {showModal && (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black/50 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-md text-slate-900 dark:text-white border border-slate-200 dark:border-gray-700">
