  ...
  return (
    <>
      <style>{`
        ...
        @media screen {
          .print-container { background: white; width: 100%; padding: 0; }
        }

        * { box-sizing: border-box; }

        /* ═══════════════════════════════════════════════════════════
           SINGLE FONT SIZE CONTROL — change ONLY this one value
           to resize the entire printed form. All children inherit.
        ═══════════════════════════════════════════════════════════ */
        .print-container {
          font-size: 9.5pt;
        }

        /* Inputs and selects inherit font from container */
        .underline-input {
          border: none;
          ...
          <div className="modal-body">
            <div ref={componentRef} className="print-container" style={{ 
              ...
              <div style={{ textAlign: 'center', marginBottom: '6px', lineHeight: '1.1' }}>
                ...
                <div className="text-lg" style={{ fontWeight: 'bold', marginTop: '3px' }}>
                  CUSTOMER ACTIVATION REQUEST FORM
                </div>
              ...
              {/* Company/Personal Name and ID Type */}
              ...
              <div style={{ marginBottom: '5px' }}>
                <div style={{ display: 'grid', gridTemplateColumns: '3fr 1fr 1fr', gap: '6px', marginBottom: '2px' }}>
                  <strong>BRANCH (SHIP TO PARTY):</strong>
                  <strong>STORE CODE:</strong>
                  <strong>TRADE NAME:</strong>
                </div>
                <div style={{ display: 'grid', gridTemplateColumns: '3fr 1fr 1fr', gap: '6px' }}>
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '5px' }}>
                <thead>
                  <tr>
                    <th style={{ border: '1px solid #000', padding: '3px', backgroundColor: '#e5e7eb', textAlign: 'center' }}>
                      TRUCK DESCRIPTION
                    </th>
                    <th style={{ border: '1px solid #000', padding: '3px', backgroundColor: '#e5e7eb', textAlign: 'center' }}>
                      CHECK CAPACITY
